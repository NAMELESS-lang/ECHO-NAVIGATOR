...
#Cria o plano dee fundo do aplicativo
...
#Cria o local onde fica a imagem do radar
rad = Image.open("C:\\Users\\mathe_u45khu0\\OneDrive\\Área de Trabalho\\projeto_radar\\radar.png")
rad_img = ctk.CTkImage(rad, size= (600,550))
...
# Cria os botões de conectar, sair e status de conexão
...
#Local onde posiciona os elementos na tela
